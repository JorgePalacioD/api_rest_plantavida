    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(configure -> configure
                        .requestMatchers("/api/auth/**", "/api/users/**", "api/payments").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/compradores/**").hasAnyRole("ADMIN", "CUSTOMER")
                        .requestMatchers(HttpMethod.POST, "/api/bonos/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/arboles/**").hasRole("ADMIN")
